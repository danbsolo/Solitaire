        ...
        if arcade.check_for_collision(self.held_cards[0], pile):
            ...
            if PLAY_PILE_1 <= pile_index <= PLAY_PILE_7:
                ...
                # Is droppedOntoPile not empty? Then set droppedOntoCard
                    ...
                    if (primaryHeldCard.suit in BLACK_SUITS and droppedOntoCard.suit in BLACK_SUITS) or (primaryHeldCard.suit in RED_SUITS and droppedOntoCard.suit in RED_SUITS):
                        reset_position = True
            ...
            # Dropping onto a foundation?
                ...
                # Is pile empty and primaryHeldCard not an ace?
                if not self.piles[pile_index] and primaryHeldCard.value != "A":
                    reset_position = True

            # if not dropping onto a tableau nor a foundation? Reset.
            else:
                reset_position = True


            # if none of the flags from earlier set reset_position to True, proceed with moving each card
